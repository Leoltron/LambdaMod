...
import ru.leoltron.lambda.eventhandler.GuiOpenEventHandler;
...
public class GuiMainMenuOverride extends GuiMainMenu {
	...
	public static final String websiteUrl = "http://ru-craft.net/";

	public GuiMainMenuOverride(GuiMainMenu inst) {
	...
	public void initGui()
    {
        ...
        else if (calendar.get(2) + 1 == 10 && calendar.get(5) == 8)
        {
            this.splashText = "\u0421 \u0434\u043D\u0435\u043C \u0440\u043E\u0436\u0434\u0435\u043D\u0438\u044F, Leolt!";
        }
        else if (calendar.get(2) + 1 == 9 && calendar.get(5) == 7)
        {
            this.splashText = "\u0421 \u0434\u043D\u0435\u043C \u0440\u043E\u0436\u0434\u0435\u043D\u0438\u044F, SkyStrider!";
        }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("\u0417\u0430\u0439\u0442\u0438 \u043D\u0430 \u0441\u0435\u0440\u0432\u0435\u0440 Lambda", new Object[0])));
        GuiButton realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, this.mc.gameSettings.language.equalsIgnoreCase("ru_RU") ? "\u0421\u0430\u0439\u0442" : "Website");
        GuiButton fmlModButton = new GuiButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, this.mc.gameSettings.language.equalsIgnoreCase("ru_RU") ? "\u0424\u043E\u0440\u0443\u043C" : "Forum");
	...
	protected void actionPerformed(GuiButton p_146284_1_)
    {
        ...
        if (p_146284_1_.id == 2)
        {
        	this.mc.displayGuiScreen(new GuiConnecting(this, mc, "ru-craft.net", 28015));
        }
        ...
        if (p_146284_1_.id == 14)
        {
        	    try
                {
                    ...
                    oclass.getMethod("browse", new Class[] {URI.class}).invoke(object, new Object[] {new URI(websiteUrl)});
                }
        ...
        if (p_146284_1_.id == 6)
        {
        	try
            {
                Class oclass = Class.forName("java.awt.Desktop");
                Object object = oclass.getMethod("getDesktop", new Class[0]).invoke((Object)null, new Object[0]);
                oclass.getMethod("browse", new Class[] {URI.class}).invoke(object, new Object[] {new URI(websiteUrl+"forum/index.php")});
            }
            catch (Throwable throwable)
            {
                logger.error("Couldn\'t open link", throwable);
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
	        ...
	        {
	            ((GuiButton)this.buttonList.get(k1)).drawButton(this.mc, p_73863_1_, p_73863_2_);
	        }
	        ...
	        this.drawCenteredString(this.fontRendererObj, "Ru-Craft", this.width/2, this.height-15, 0xffffff);
    }
	
	protected void keyTyped(char p_73869_1_, int p_73869_2_) {
		if(Keyboard.isKeyDown(Keyboard.KEY_F3) && Keyboard.isKeyDown(Keyboard.KEY_L)){
			GuiOpenEventHandler.debug = true;
